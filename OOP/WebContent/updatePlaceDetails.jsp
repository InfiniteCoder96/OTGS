...
<div class="container">
	<div class="row">
		...
		<div class="col-xs-4 col-xs-offset-4">
			...
			<form action="PlacesControllerServlet" method="post" enctype="multipart/form-data">
			
					<input type="hidden" name="update" value="${place.getID()}"/>
					<input type="hidden" name="command" value="UPDATE"/>
					
					<div class="form-group">
						<label style="color:#726E6E">Hotel ID</label>
						<input class="form-control" type="text" name="user_id" value="${place.getID()}" disabled="disabled">
					
					</div>
					<div class="form-group">
						<label style="color:#726E6E">Hotel Name</label>
						<input class="form-control" type="text" name="name" value="${place.getPlace_name()}">
					
					</div>
					<div class="form-group">
						<label style="color:#726E6E">City</label>
						<input class="form-control" type="text" name="city" value="${place.getPlace_id()}">
						
					</div>
					<div class="form-group">
						<label style="color:#726E6E">Address</label>
						<input class="form-control" type="text" name="address" value="${place.getP_category()}">
						
					</div>
					<div class="form-group">
						<label style="color:#726E6E">Telephone</label>
						<input class="form-control" type="text" name="phone" value="${place.getPlace_city()}">
					...
					<div class="form-group">
						...
						<select class="form-control"  name="hotelType" ">
							...
							<option value="${place.getP_category()}" selected>${place.getP_category()}</option>
							<option>Scenic beauty</option>
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="web" value="${place.getP_caption()}">
						
					</div>
					<div class="form-group">
						
						
						<img src="${place.getP_img_filename()}" style="width:200px;height:200px">
					</div>
					<br><br>
					<div class="form-group">
