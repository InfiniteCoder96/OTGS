	...
	<div class="container" style="margin-top: 200px; margin-bottom: 200px">
		...
		<div class="row">
			...
			<div class="col-md-6 col-md-offset-3 ">
				...
				<div class="well" style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.5); background-color: #C94A21">
				<div style="color:white">This Page will closes in <span id="time">00:30</span></div>
					<form onsubmit="return PW_Validate()" action="UserControllerServlet" method="post" >
						<%
							String token = request.getParameter("token");
						%>
						<%
							String user_id = token.substring(0, 6);
						%>
						...
						<div class="form-group">
							<label style="color: white">Confirm Password</label> <input
								class="form-control" placeholder="Re-Enter Password here"
								type="password" id="con_password" required />
