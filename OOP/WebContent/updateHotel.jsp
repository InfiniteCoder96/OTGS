...
<div class="container">
	<div class="row">
		<center><p style="color: white; font-family: 'Finger Paint', cursive;font-size:40px">Hotel Details Update Portal</p></center>
		<div class="col-xs-4 col-xs-offset-4">
			
			<form method="post" action="ReservationHandler" >
			
					<input type="hidden" name="update" value="${propertyList.getID()}"/>
					
					
					<div class="form-group">
						<label style="color:#726E6E">Hotel ID</label>
						<input class="form-control" type="text" name="user_id" value="${propertyList.getID()}" disabled="disabled">
					
					</div>
					<div class="form-group">
						<label style="color:#726E6E">Hotel Name</label>
						<input class="form-control" type="text" name="name" value="${propertyList.getName()}">
					
					</div>
					<div class="form-group">
						<label style="color:#726E6E">City</label>
						<input class="form-control" type="text" name="city" value="${propertyList.getCity()}">
						
					</div>
					<div class="form-group">
						<label style="color:#726E6E">Address</label>
						<input class="form-control" type="text" name="address" value="${propertyList.getAddress()}">
						
					</div>
					<div class="form-group">
						<label style="color:#726E6E">Telephone</label>
						<input class="form-control" type="text" name="phone" value="${propertyList.getPhone()}">
					
					</div>
					<div class="form-group">
					
						<label style="color:#726E6E">Category</label>
						<select class="form-control"  name="hotelType" ">
							
							
							<option value="${propertyList.gettype()}" selected>${propertyList.gettype()}</option>
							<option>Star Class</option>
							<option>Bontique</option>
							<option>Heritage</option>
							<option>Home Stay</option>
							<option>Apartment</option>
							<option>Bunglow</option>
							<option>Sri Lanka Tourism Hotel</option>
					...
					<div class="form-group">
						<label style="color:#726E6E">Web Address</label>
						<input class="form-control" type="text" name="web" value="${propertyList.getWeb()}">
						
					</div>
					<div class="form-group">
						<label style="color:#726E6E">Image Url</label>
						<input class="form-control" type="text" name="web" value="${propertyList.getPictureUrl()}">
