...
<div class="container">
	<div class="row">
		<center><p style="color: white; font-family: 'Finger Paint', cursive;font-size:40px">User Details Update Portal</p></center>
		<div class="col-xs-4 col-xs-offset-4">
			...
			<form method="post" action="UserControllerServlet" >
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="user_id" value="${THE_USER.id}" disabled="disabled">
					
					</div>
					<div class="form-group">
						<label style="color:white">First Name</label>
						<input class="form-control" type="text" name="firstName" value="${THE_USER.firstName}">
					
					</div>
					<div class="form-group">
						<label style="color:white">Last name</label>
						<input class="form-control" type="text" name="lastName" value="${THE_USER.lastName}">
						
					</div>
					<div class="form-group">
						<label style="color:white">Email</label>
						<input class="form-control" type="text" name="email" value="${THE_USER.emailAddress}">
					...
					<div class="form-group">
						...
						<select class="form-control"  name="country" >
							...
							<option value="${THE_USER.country}" selected>${THE_USER.country}</option>
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="username" value="${THE_USER.username}">
